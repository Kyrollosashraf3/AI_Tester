...
Extraction:
  * If intent_classifier exists, extract the intent_type or response as intent_response.
  * If memory_extraction exists, look extracted_memories.
  * If extraction_model exists, extract the extracted_answers as extraction_answers.
- if you found any unexpected value in all of them : add to output json bug_description: <describe in 8 words> or None.
